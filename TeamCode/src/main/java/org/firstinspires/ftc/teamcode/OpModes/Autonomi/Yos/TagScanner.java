        ...
        public void runOpMode() throws InterruptedException {
            ...
            while (opModeIsActive()) {
                ...
                for (AprilTagDetection detection : aprilTagProcessor.getDetections()) {
                    ...
                    telemetry.addLine(("Howdy! Searching for Tag..."));

                    Thread.sleep(500);

                    driveTrain.turnToHeading(gyro, telemetry, 10);
                ...
                if (targetFound) {
                    ...
                    double theDistance = Math.cos(pitch) * range;

                    if (desiredTag.ftcPose.bearing != 0) {
                        driveTrain.turnToHeading(gyro, telemetry, -bearing);
                        driveTrain.moveForwardsBy(telemetry, x);
                        driveTrain.turnToHeading(gyro, telemetry, 90);
                        driveTrain.moveForwardsBy(telemetry, theDistance);
